...
(async function () {
  ...
  const DATA_URL = 'js/data/cnboriental_tea&coffe.json'; // ← đổi sang file JSON của bạn
...
const CATEGORY_RULES = [
  {
    name: 'JAPANESE TEA',
    patterns: [
      /\bjapanese\s*tea\b/i, /\bgreen\s*tea\b/i,
      /\bhojicha\b/i, /\bgenmaicha\b/i, /\bgyokuro\b/i,
      /\bsencha\b/i, /\bmatcha\s*leaf\b/i, /\btea\s*leaf\b/i
    ]
  },
  {
    name: 'MATCHA',
    patterns: [
      /\bmatcha\b/i, /\bchasen\b/i, /\bchashaku\b/i, /\bmatcha\s*bowl\b/i,
      /\bmatcha\s*set\b/i, /\bmatcha\s*whisk\b/i, /\btea\s*ceremony\b/i
    ]
  },
  {
    name: 'MUGS & CUPS',
  ...
  },
  {
    name: 'TEAPOTS',
    patterns: [
      /\bteapot(s)?\b/i, /\bkyusu\b/i, /\bcast\s*iron\s*teapot\b/i,
      /\bceramic\s*teapot\b/i, /\bporcelain\s*teapot\b/i
    ]
  },
  {
    name: 'TEA CONTAINERS',
    patterns: [
      /\btea\s*container(s)?\b/i, /\btea\s*caddy\b/i,
      /\bcanister(s)?\b/i, /\bjar(s)?\b/i, /\btea\s*tin(s)?\b/i
    ]
  },
  {
    name: 'TEATIPS',
    patterns: [
      /\btea\s*tip(s)?\b/i, /\bdrip\s*tray\b/i, /\brest\b(?=.*\btea\b)/i
    ]
  },
  {
    name: 'TEA STRAINERS & TEA ACCESSOIRES',
    patterns: [
      /\bstrainer(s)?\b/i, /\bfilter(s)?\b/i, /\binfuser(s)?\b/i,
      /\btea\s*accessory\b/i, /\baccessoire(s)?\b/i,
      /\btea\s*tool(s)?\b/i, /\btea\s*set\b/i
    ]
  },
  {
    name: 'SPOONS',
    patterns: [
      /\bspoon(s)?\b/i, /\btea\s*spoon(s)?\b/i,
      /\bmeasure\b(?=.*\btea\b)/i, /\bstirrer(s)?\b/i
    ]
  },
  {
    name: 'CAST IRONWARE',
