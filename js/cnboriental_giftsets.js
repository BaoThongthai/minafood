...
(async function () {
  ...
  const DATA_URL = 'js/data/cnboriental_giftsets.json'; // ← đổi sang file JSON của bạn
...
const CATEGORY_RULES = [
  {
    name: 'SUSHI SETS',
    patterns: [
      /\bsushi\s*set(s)?\b/i, /\bsashimi\s*set(s)?\b/i,
      /\bsushi\s*plate\s*set\b/i, /\bsushi\s*dish\s*set\b/i,
      /\bsushi\s*boat\s*set\b/i
    ]
  },
  {
    name: 'BOWL SETS',
    patterns: [
      /\bbowl\s*set(s)?\b/i, /\brice\s*bowl\s*set\b/i,
      /\bnabe\s*set\b/i, /\bnoodle\s*bowl\s*set\b/i,
      /\bramen\s*set\b/i, /\bsoup\s*bowl\s*set\b/i
    ]
  },
  {
    name: 'PLATE SETS',
    patterns: [
      /\bplate\s*set(s)?\b/i, /\bdish\s*set(s)?\b/i,
      /\bserving\s*plate\s*set\b/i, /\bplatter\s*set\b/i
    ]
  },
  {
    name: 'TEA SETS',
    patterns: [
      /\btea\s*set(s)?\b/i, /\bkyusu\s*set\b/i,
      /\bteapot\s*set\b/i, /\bmatcha\s*set\b/i
    ]
  },
  {
    name: 'CUP & MUG SETS',
    patterns: [
      /\bcup\s*set(s)?\b/i, /\bmug\s*set(s)?\b/i,
      /\bcoffee\s*set\b/i, /\bespresso\s*set\b/i,
      /\bdrinking\s*set\b/i
    ]
  },
  {
    name: 'CHOPSTICK SETS WITH GIFTBOX',
    patterns: [
      /\bchopstick\s*set(s)?\b/i, /\bgift\s*box\b/i,
      /\bwith\s*box\b/i, /\bpresent\s*set\b/i,
      /\bchopstick\s*gift\s*set\b/i
    ]
  }
];
