...
(async function () {
    ...
    const DATA_URL = "js/data/Combisteel_faucets.json";
    ...
    const FILTER_CONFIG = {
        ...
        height: {
            ...
            buckets: [
                ...
                { id: "h-800-999", label: "800 – 999", min: 800, max: 999 }, // giống hình
            ],
        },
        ...
        price: {
            label: "PRICE",
            key: "price", // dùng trực tiếp giá số
            type: "range",
            buckets: [
                {
                    id: "p-0-999-99",
        ...
        material: {
            ...
            buckets: [
                ...
                { id: "m-chromed-brass", label: "Chromed brass", value: "Chromed brass" }, // hoặc đúng value trong JSON
            ],
        },
