...
(async function () {
  ...
  const DATA_URL = 'js/data/cnboriental_chopsticks.json'; // ← đổi sang file JSON của bạn
  ...
  const CATEGORY_RULES = [
    ...
    },
    {
      ...
      patterns: [
        /\bchild(ren)?\b/i, /\bkid(s)?\b/i, /\btrainer\b/i, /\blearning\b/i,
        /\bring\b(?=.*\bchopstick)/i, /\bhelper\b(?=.*\bchopstick)/i
      ]
    },
    {
