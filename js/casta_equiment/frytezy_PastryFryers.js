...
(async function () {
  ...
  const DATA_URL = "js/casta_equiment/data/frytezy_PastryFryers.json";
  ...
  function renderCategorySidebar() {
    ...
    slot.innerHTML = `
       <a href="Fritezyprime700.html" class="mf-filter-row d-flex justify-content-between mt-3">
          ...
          <a href="Fritezy_PastryFryers.html" class="mf-filter-row d-flex justify-content-between active1">
